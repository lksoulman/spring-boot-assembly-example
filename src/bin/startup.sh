...
#======================================================================
# 项目启动shell脚本
# main目录: spring boot jar包
# conf目录: 配置文件目录
# logs目录: 项目运行日志目录
# logs/spring-boot-assembly-example_startup.log: 记录启动日志
...
# 打印启动命令
STARTUP_LOG="${STARTUP_LOG}application background startup command: nohup java ${JAVA_OPT} -jar ${BASE_PATH}/main/${APPLICATION_JAR} --spring.config.location=${CONFIG_DIR} > ${LOG_PATH} 2>&1 &\n"
